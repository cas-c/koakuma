...
const onMessageReactionRemove = (messageReaction, user) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (roleJson && (roleJson === null || roleJson === void 0 ? void 0 : roleJson.roleId) && user) {
        ...
        yield (targetUser === null || targetUser === void 0 ? void 0 : targetUser.roles.remove(roleJson.roleId));
    }
    return;
});
exports.default = onMessageReactionRemove;
//# sourceMappingURL=onMessageReactionRemove.js.map